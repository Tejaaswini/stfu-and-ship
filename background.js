// Create a listener function for onBeforeRequest event
function redirectOnBeforeRequest(details) {
...
// Register the listener using the WebExtensions API
browser.webRequest.onBeforeRequest.addListener(
  redirectOnBeforeRequest,
